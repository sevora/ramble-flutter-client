...
class RambleIconButton extends StatefulWidget {
  const RambleIconButton({
    super.key,
    required this.icon,
    this.borderColor,
    this.borderRadius,
  ...
  @override
  State<RambleIconButton> createState() => _RambleIconButtonState();
}

class _RambleIconButtonState extends State<RambleIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(RambleIconButton oldWidget) {
